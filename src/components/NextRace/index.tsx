...
export default function NextRace() {
  ...
  return (
    <div className="px-6 lg:px-10 pt-6 lg:pt-10 pb-6 lg:pb-10">
      <div
        className={`fixed w-full h-full bg-gray-700 top-0 left-0 items-center justify-center ${
      ...
      >
        <div role="status">
          <svg
            aria-hidden="true"
            className="w-24 h-24 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-[#DA2535]"
            viewBox="0 0 100 101"
            fill="none"
